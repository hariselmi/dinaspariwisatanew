            ...
            <div class="main-content">
                ...
                <nav class="navbar-custom-menu navbar navbar-expand-xl m-0 navbar-transfarent">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="dashboard.html"><i class="typcn typcn-point-of-interest-outline top-menu-icon"></i>Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="add-listing.html"><i class="typcn typcn-point-of-interest-outline top-menu-icon"></i>Add Listing</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle material-ripple" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="typcn typcn-weather-stormy top-menu-icon"></i>My Listing
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="my-listing.html">Active</a></li>
                                    <li><a class="dropdown-item" href="my-listing.html">Pending</a></li>
                                    <li><a class="dropdown-item" href="my-listing.html">Expired</a></li>
                                </ul>
                            </li>
                          
                            <li class="nav-item">
                                <a class="nav-link" href="gallery.html"><i class="typcn typcn-point-of-interest-outline top-menu-icon"></i>Gallery</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="event.html"><i class="typcn typcn-point-of-interest-outline top-menu-icon"></i>Event</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="news.html"><i class="typcn typcn-point-of-interest-outline top-menu-icon"></i>News</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="profile-element d-flex align-items-center flex-shrink-0 p-0 text-start">
                                        ...
                                        <div class="profile-text">
                                            <h6 class="m-0 fw-medium fs-14">Hariselmi</h6>
                                            <span>hariselmi@gmail.com</span>
                                        </div>
                                    </div>
                                </a>
                ...
                <div class="body-content">
                    ...
                    <div class="container-xxl">
                        ...
                        <div class="header-banner align-items-center d-flex justify-content-between mb-3 p-4 rounded-4 w-100">
                            <div class="header-banner-context">
                                <h3 class="align-items-center d-flex fs-5 gap-2 text-white mb-3">
                                    <img src="assets/dist/img/mini-logo.png" alt="" width="35">
                                    Sistem Informasi Pariwisata dan Kebudayaan
                                </h3>
                                <div class="content-text fs-14 opacity-75 text-white">Dinas Kebudayaan dan Pariwisata Kota Batam.</div>
                                <div class="content-text fs-14 opacity-75 text-white">Pemerintah Kota Batam.</div>
                            </div>
                            <img class="content-wrapper-img" src="assets/dist/img/glass.png" alt="" width="180">
                        </div>
                        <!-- End /. header banner -->
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3 d-flex">
                                <div class="card flex-column flex-fill p-4 position-relative shadow w-100 widget-card">
                                    <div class="d-flex">
                                        <div class="flex-grow-1 ms-3">
                                            <div class="fs-14 text-muted">Progress</div>
                                            <h3 class="fw-semi-bold mb-0">70%</h3>
                                        </div>
                                        <div class="flex-shrink-0">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3 d-flex">
                                <div class="card flex-column flex-fill p-4 position-relative shadow w-100 widget-card">
                                    <div class="d-flex">
                                        <div class="flex-grow-1 ms-3">
                                            <div class="fs-14 text-muted">Revenue</div>
                                            <h3 class="fw-semi-bold mb-0">$100</h3>
                                        </div>
                                        <div class="flex-shrink-0">
                        ...
                        <div class="card mb-3 p-4 total-box">
                            <div class="g-4 gx-xxl-5 row">
                                ...
                                <div class="col-sm-4 total-box__right">
                                    ...
                                    <p class="mb-0 fw-semibold fs-14">
                                        <span class="text-primary">9.01%</span>&nbsp;&nbsp; decrease compared to last week
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header position-relative">
                                <h6 class="fs-17 fw-semi-bold my-1">Recent Booking</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-borderless text-nowrap category-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="listing-details.html" class="btn btn-primary fw-medium btn-sm d-inline-flex align-items-center justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="avatar avatar-sm avatar-circle">
                                                        <img class="avatar-img" src="assets/dist/img/avatar/02.jpg" alt="Image Description">
                                                    </span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="avatar avatar-sm avatar-circle">
                                                        <img class="avatar-img" src="assets/dist/img/avatar/04.jpg" alt="Image Description">
                                                    </span>
                                                </td>
                                                <td>Gabriel Nort</td>
                                                <td>10 Jul 2023</td>
